...
import { Gift, BarChart3, Megaphone, Users, Ticket, PieChart, QrCode, LogOut, Store, Settings, Target, Package } from "lucide-react";
...
const navigation = [
  ...
  { name: "Products", href: "/points-setup", icon: Package },
